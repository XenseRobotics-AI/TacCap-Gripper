...
PYBIND11_MODULE(_taccap_native, m) {
    ...
    py::enum_<tp::Cmd>(m, "Cmd")
        ...
        .value("Ws2812Set",          tp::Cmd::Ws2812Set)
        .value("Ws2812Effect",       tp::Cmd::Ws2812Effect)
        ...
        .value("MotorGetPrivateParam", tp::Cmd::MotorGetPrivateParam)
        .value("MotorSetPrivateParam", tp::Cmd::MotorSetPrivateParam)
        ...
        .value("GetUartStats",       tp::Cmd::GetUartStats)
        .value("SetLogConfig",       tp::Cmd::SetLogConfig)
        ...
        .value("SetGripperAutoCalConfig", tp::Cmd::SetGripperAutoCalConfig)
        .value("GetGripperAutoCalConfig", tp::Cmd::GetGripperAutoCalConfig)
