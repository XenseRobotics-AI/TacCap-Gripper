"""Advanced TacCap API: device components, controllers, tuning and protocol.

For daily follower operation use ``xense.taccap.Gripper``. This module preserves
native API names for diagnostics, integration and algorithm development.
"""
...
ControlLoop = _taccap_native.ControlLoop              # native impedance controller
...
ForcePositionMode = _taccap_native.ForcePositionMode
...
MotorExecutionStatus = _taccap_native.MotorExecutionStatus
...
__all__ = [  # noqa: RUF022 - group exports by subsystem.
    "__version__",
    "hello",
    # Logging
    "log",
